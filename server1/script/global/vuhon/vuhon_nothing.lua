------------------------------------------------------------------------------------------------------------
function main()
	local szTitle = "Xin chµo "..GetName().."! <color=fire>Vò Hån §­êng<color> h©n h¹nh ®ãn tiÕp ng­êi cña <color=yellow>PYTA Gaming<color> ghÐ th¨m. B¹n cã thÝch n¬i nµy kh«ng?"
	local tbOpt=
	{
