...
function education_givemeat()
	...
	if ( Uworld1066 > 0 ) then
		Describe(DescLink_WuShi.."<#>:Ng­¬i ®· nhËn nhiÖm vô t×m thŞt t­¬i råi! Kh«ng cÇn nh©n n÷a! Ng­¬i hiÖn cã "..Uworld1066.." miÕng thŞt t­¬i ®i! H·y Ên phİm <color=red>F12<color> ®Ó xem h­íng dÉn chi tiÕt vÒ nhiÖm vô!",1,"KÕt thóc ®èi tho¹i/no")
	else
