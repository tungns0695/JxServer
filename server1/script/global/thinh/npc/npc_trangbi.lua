...
function dialog_trangbi_main()
	...
	{"Më réng r­¬ng/moruong",
        "NhËn LÖnh Bµi Lµm NV D· TÈu/nhandataulenhbai",
        "§å Xanh - TÝm/dialog_xanhtim",
        "NhËn Full Ngùa/nhanngua",
	"NhËn Trang BÞ Hoµng Kim/hoangkim",
        "NhËn set Hoµng Kim - B¹ch Kim/chose_type_goldquip",
	"N©ng cÊp Trang BÞ B¹ch Kim/bachkim_main",
	"Tho¸t./no",
	}
...
function hoangkim()
	...
	local tbOpt=
	{
	"NhËn ®å Hoµng Kim th­êng/TrangBiHoangKimThuong",
	"NhËn Set HKMP/SetTrangBiHoangKim",
...
local tbOpt =
	{"LÊy tÊt c¶ Ngùa/nhanngua1",
	"Ngùa 8x/nguathuong",
	"Ngùa Cao CÊp/nguavolam",
