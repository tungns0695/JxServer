...
function tl_gettaskinfo()
	...
	if (myTaskType == 1) then
		...
		myMainTalk = "H·y ®i <color=yellow>" ..
		myTaskInfo1 .. "<color> Mua gióp ta <color=yellow>" .. myTaskOrder .. "<color> vÒ ®©y!";
	...
	elseif (myTaskType == 2) then
		...
		if (myTaskOrder == "n") then
			...
			myMainTalk = "H·y gióp ta ®i t×m mãn nµy: <color=yellow>" ..
			myTaskInfo1 ..
			"<color>, <color=yellow>" ..
			myTaskOrder ..
			"<color>, nhá nhÊt: <color=yellow>" ..
			myTaskInfo2 .. "<color>, lín nhÊt: <color=yellow>" .. myTaskInfo3 .. "<color>.";
		end
	...
	elseif (myTaskType == 3) then
		...
		myTaskOrder ..
		"<color>, nhá nhÊt: <color=yellow>" ..
		myTaskInfo1 .. "<color>, lín nhÊt: <color=yellow>" .. myTaskInfo2 ..
		"<color>! Xem xong ta sÏ tr¶ l¹i cho ng­¬i";
	...
	elseif (myTaskType == 4) then
		...
		myTaskMainInfo = "Ng­¬i h·y ®Õn <color=yellow>" ..
		myTaskOrder ..
		"<color> t×m gióp ta <color=yellow>" .. myTaskInfo1 ..
		"<color> quyÓn <color=yellow> " .. myTaskInfo3 .. " <color>.";
	elseif (myTaskType == 5) then
...
function AssignValue_TaskTalk(myTaskVariable, myTaskTextID)
	...
	for i = 1, 6 do
		tl_print("§èi tho¹i nhiÖm vô hiÖn t¹i  " .. i ..
		"  Tæng sè ch÷ sè nguyªn tè lµ: " .. getn(myTaskVariable[i]));
	end
